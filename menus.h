...
void menuPedidos(int *num_pedidos, int *num_veiculos, int *num_locais, 
	...
	switch (opcao){
		...
		case 5:
			...
			if (*num_pedidos>0 && *num_veiculos>0)
				enviaPedido(num_pedidos, num_veiculos, num_locais, 
						pedidos, veiculos, locais);
			break;
		case 6:
			break;
	}
	...
	while (true){
		...
		switch (opcao){
			...
			case 2:
				...
				break;
			case 3:
				menuPedidos(num_pedidos, num_veiculos, 
					num_locais, pedidos, veiculos, locais);
				break;
			case 4:
				limpaTela();
